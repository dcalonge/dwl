...
/* Keybindings */
    ...
    static const Key keys[] = {
        ...
        { 0,                              XKB_KEY_XF86MonBrightnessUp, spawn,     SHCMD("brightnessctl set +5% > /dev/null && kill -54 $(pidof someblocks)") },
        { 0,                              XKB_KEY_XF86MonBrightnessDown,spawn,    SHCMD("brightnessctl set 5%- > /dev/null && kill -54 $(pidof someblocks)") },
